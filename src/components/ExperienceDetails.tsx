...
export default function ExperienceDetails({
  ...
  return (
    <div className="bg-content4 pt-8 pb-16">
      <Container>
        <div className="flex flex-wrap items-center">
          <div className="pb-10 sm:pb-0 sm:mb-0 md:w-1/2 md:pr-12 md:border-r md:border-b-0 border-b border-foreground">
            ...
            <p className="text-content2 leading-relaxed text-base text-justify xl:text-left">
              Possuo uma forte capacidade de resolução de problemas e trabalho
              bem em equipe. Sou capaz de dar e receber feedbacks aos meus
              companheiros, além disso sou extremamente eficiente no meu
              trabalho.
            </p>
            <Link
